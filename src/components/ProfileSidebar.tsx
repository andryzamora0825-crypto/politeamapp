...
export function ProfileSidebar({ profile, currentUserId }: ProfileSidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>, label: "Lives", href: "/lives" },
